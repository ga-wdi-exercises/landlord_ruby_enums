...
# Use enumerables to -
  ...
  # puts tenant.name
  # whose_apartment = apartments.find{|apartment| apartment[:id] == tenant[:apartment_id]}
  # puts whose_apartment.name
  # end

  # apartments.each do |apartment|
  # puts apartment.address
  # tenants_per_apartment = tenants.select{|tenant| tenant.apartment_id == apartment.id}
  # tenants_per_apartment.each do |tenant|
  # puts tenant.name
  # end
  # end
