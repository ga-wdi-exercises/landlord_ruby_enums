def data
  # Array of apartment object each with an id, address, rent and sqft
  apartments = [
...
# Array of tenant objects each with an id, name, age and apartment_id
  tenants = [
  ...
  # Returns an object with apartments array and tenants array.
