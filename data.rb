...
def data
  ...
  # The data for the apartments is structured in hashes with key/value pairs pointing to the properties:  ID #'s, Physical address, Rent cost, and sq footage.
  # The data for the tenants is also stored in a hash using key/value pairs representing the properties: ID, Name, Age, and its respective apartment ID
