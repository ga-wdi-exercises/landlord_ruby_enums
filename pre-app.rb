...
# First, Open the data.rb an inspect the data. Identify and write, in comments, the following:
    ...
    # The data are hashes in two variables. Lots of key value pairs to iterate through.
    # What are the properties for each of the two types of hashes
    # They both have :id as a property with a total of 4 properties.
    # apartments has :address, :monthly_rent, :square_feet.
    # A total of 4 properties.
    # tenants has :name, :age, and :apartment_id.
